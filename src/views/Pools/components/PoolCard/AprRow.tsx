...
const AprRow: React.FC<AprRowProps> = ({ pool, stakedBalance, performanceFee = 0 }) => {
  ...
  console.log('alex: stakingToken = ', stakingToken.symbol)
  console.log('alex: stakingTokenPrice = ', stakingTokenPrice)
  console.log('alex: stakingTokenBalance = ', stakingTokenBalance.toNumber())
