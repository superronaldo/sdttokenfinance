...
const StakeModal: React.FC<StakeModalProps> = ({
  ...
  const { sousId, farmId, stakingToken, earningTokenPrice, apr, userData, stakingLimit, earningToken } = pool
  const { t } = useTranslation()
  const { theme } = useTheme()
  const { onStake } = useStakePool(sousId, farmId, isBnbPool)
  const { onUnstake } = useUnstakePool(sousId, farmId, pool.enableEmergencyWithdraw)
