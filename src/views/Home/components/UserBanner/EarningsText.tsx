...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and SDT pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and SDT pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from SDT pool', data)
  }
